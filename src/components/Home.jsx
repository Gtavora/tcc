...
function Home() {
  return (
    <div className="bg-gray min-h-screen flex flex-col items-center">
      ...
      <main className="container mx-auto px-12 py-3 flex-1">
        ...
        <section className="my-12">
          ...
          <ul className="list-disc ml-8 mt-7 space-y-4 text-lg">
            <li>
        ...
        <section className="my-12">
          <h2 className="text-4xl font-bold text-blue-400">Público Alvo</h2>
          <ul className="list-disc ml-8 mt-7 space-y-4 text-lg">
        ...
        <section className="my-12">
          <h2 className="text-4xl font-bold text-blue-400">Nossas Referências</h2>
          <ul className="list-disc ml-8 mt-7 space-y-4 text-lg">
